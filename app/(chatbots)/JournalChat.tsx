            ...
            >
                {messages.length === 0 || showPrompts ? (
                    <View style={styles.welcomeContainer}>
                        ...
                        {/* Replace the mood container with EmojiContainer */}
                        <EmojiContainer
                            onMoodSelect={(moodId) => handleMoodSelect(Number(moodId))}
                            disableNavigation={true}  // This disables navigation only here
                        />
                ...
                {/* Rest of your scroll view content remains the same */}
